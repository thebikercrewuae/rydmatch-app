  ...
  static List<BadgeModel> allBadges() {
    return [
      ...
      BadgeModel(
        id: 'photo_pro',
        name: 'Photo Pro',
        description: 'Showcased your ride setup with 6 photos.',
        unlockCriteria: 'Upload 6 ride setup photos',
        category: BadgeCategory.profile,
      ...
      BadgeModel(
        ...
        description: 'Shows up for weekend rides.',
      ...
      BadgeModel(
        id: 'speed_demon',
        name: 'Pace Setter',
        description: 'Reached a standout top speed during a live ride.',
        unlockCriteria: 'Reach the pace milestone for your ride community',
        category: BadgeCategory.rideMilestones,
        icon: Icons.bolt_rounded,
