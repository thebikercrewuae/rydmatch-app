...
class _OnboardingScreenState extends State<OnboardingScreen>
        ...
        child: SafeArea(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final topBarVerticalPadding = isTightHeight ? 1.0.h : 1.5.h;
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(
                      4.w,
                      isTightHeight ? 1.h : 1.5.h,
                      4.w,
                      isTightHeight ? 1.h : 2.h,
                    ),
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: isTightHeight ? 1.5.h : 2.5.h),
                        ...
                        SizedBox(height: isTightHeight ? 1.h : 1.5.h),
                        // Legal links
                        Wrap(
  ...
  Widget _buildPageContent(int index) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final isTightHeight = constraints.maxHeight < 520;
        final illustrationHeight = isTightHeight
            ? constraints.maxHeight * 0.28
            : constraints.maxHeight * 0.34;
        final illustrationWidth = constraints.maxWidth > 720 ? 520.0 : 70.w;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: isTightHeight ? 2.h : 4.h),
                  ...
                  SizedBox(height: isTightHeight ? 1.2.h : 2.h),
