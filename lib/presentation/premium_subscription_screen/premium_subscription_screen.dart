...
class _PremiumSubscriptionScreenState extends State<PremiumSubscriptionScreen>
  ...
  Widget _buildSubscriptionDisclosure() {
    return Padding(
      ...
      child: Text(
        'RydMatch Premium automatically renews unless auto-renew is turned off at least 24 hours before the end of the current period. Your account will be charged for renewal within 24 hours prior to the end of the current period. Subscriptions may be managed by the user and auto-renewal may be turned off by going to your Account Settings after purchase. Any unused portion of a free trial period will be forfeited when purchasing a subscription.',
        textAlign: TextAlign.center,
        style: GoogleFonts.dmSans(
          fontSize: 9.sp,
