...
class TermsOfServiceScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Last updated: ${RydMatchLegalContent.termsLastUpdated}',
                          style: GoogleFonts.dmSans(
                            fontSize: 10.sp,
            ...
            SizedBox(height: 2.h),
            // Sections
            ...RydMatchLegalContent.termsSections.map(
  ...
  Widget _buildFooter({
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.info_outline_rounded, color: accentOrange, size: 18),
          SizedBox(width: 3.w),
          Expanded(
            child: Text(
              'By using RydMatch, you agree to these terms. Questions? Contact legal@rydmatch.app',
              style: GoogleFonts.dmSans(
                fontSize: 10.sp,
                color: subtextColor,
                height: 1.5,
